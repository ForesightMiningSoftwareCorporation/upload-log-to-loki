...
exports.parse_logs = void 0;
const fs = __importStar(__nccwpck_require__(5747));
const parse_logs = (log_file, separator = '; ') => {
    try {
        ...
        for (const line of raw_entries.split('\n')) {
            ...
            if (isNaN(date.getTime()))
                continue;
            const timestamp = date.getTime() * 1e6 + parseInt(nanoseconds.replace('Z', ''), 10);
...
const logs_1 = __nccwpck_require__(9997);
...
const upload = (entries, url, org_id, username, password, loki_labels) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield (0, node_fetch_1.default)(`${url}/loki/api/v1/push`, options);
});
